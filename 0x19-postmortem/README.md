...
![](https://github.com/21Insight/holberton-system_engineering-devops/blob/master/0x19-postmortem/images/sites%20available.PNG?raw=true)
![](https://github.com/21Insight/holberton-system_engineering-devops/blob/master/0x19-postmortem/images/document%20root.PNG?raw=true)
- May 20
...
![](https://github.com/21Insight/holberton-system_engineering-devops/blob/master/0x19-postmortem/images/psaux.PNG?raw=true)
* 10:30 a.m: Use the strace command to the root apache server process with null result for every line. -root
![](https://github.com/21Insight/holberton-system_engineering-devops/blob/master/0x19-postmortem/images/strace%20127.PNG?raw=true)
* 11:00 a.m: Use the strace command to the data apache server process with a long list of return -1 errors. www-data
[Links](https://github.com/21Insight/holberton-system_engineering-devops/blob/master/0x19-postmortem/images/strace%20161.txt)
- May 21
...
[Links](https://github.com/21Insight/holberton-system_engineering-devops/blob/master/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
* 12:00 am: Error fixed and requests responded 200
![](https://github.com/21Insight/holberton-system_engineering-devops/blob/master/0x19-postmortem/images/working.PNG?raw=true)
...
![](https://github.com/21Insight/holberton-system_engineering-devops/blob/master/0x19-postmortem/images/accessing.PNG?raw=true)
